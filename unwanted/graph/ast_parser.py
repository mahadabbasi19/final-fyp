...
def extract_file_dependencies(self, current_file: str) -> List[Dict]:
    dependencies = []
    ...
    # class inheritance
    for class_decl in self.tree.types:
        if hasattr(class_decl, "extends") and class_decl.extends:
            dependencies.append({
                "source": current_name,
                "target": class_decl.extends.name + ".java",
                "type": "extends"
            })
